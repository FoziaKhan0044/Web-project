 ...
 <html lang="en" dir="ltr">
   ...
   <body>
     ...
     <div class="container-fluid" style="width:90%">
       ...
       <div class="row">
         <div class="col-md-2">
           <a href="staff_details.php" class="btn btn-outline-dark" style="width:100px;">Back</a>
         </div>
         <div class="col-md-3">
           <h3>Staff Details</h3>
         </div>
       ...
       <tbody style="text-align: center">
         ...
         $query = "SELECT * FROM staff WHERE name='$search' OR email='$search' ORDER BY name ASC";
